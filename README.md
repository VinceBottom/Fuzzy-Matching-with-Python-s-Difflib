This will allow you to match two datasets based on names of varying spellings and styles (ex: one dataset has initials but one doesn't) along with date of birth in order to merge two datasets together. 
